...
type CatGLTFResult = GLTF & {
  nodes: {
    cat004: THREE.SkinnedMesh;
    cat004_1: THREE.SkinnedMesh;
    root: THREE.Bone;
  };
  materials: {
...
export type CatActionName =
  ...
  | "Run"
  | "Walk";
type CatGLTFActions = Record<CatActionName, THREE.AnimationAction>;

export function Model(props: JSX.IntrinsicElements["group"]) {
  const group = useRef<THREE.Group>();
  const { nodes, materials, animations } = useGLTF("/cat.glb") as CatGLTFResult;
  const { actions } = useAnimations<CatGLTFActions>(animations, group);
  return (
        ...
        <group name="rig" rotation={[Math.PI / 2, 0, 0]}>
          <group name="cat">
            <skinnedMesh
              ...
              receiveShadow
              name="cat004"
              geometry={nodes.cat004.geometry}
              material={materials["Material.009"]}
              skeleton={nodes.cat004.skeleton}
            />
            <skinnedMesh
              castShadow
              receiveShadow
              name="cat004_1"
              geometry={nodes.cat004_1.geometry}
              material={materials["Material.010"]}
              skeleton={nodes.cat004_1.skeleton}
            />
          </group>
